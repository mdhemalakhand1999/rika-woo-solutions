...
use Rika_Woo_Solutions\Addons\Countdown\Frontend\Countdown;
...
class Hooks {
    ...
    */
    ...
    public function __construct() {
        add_action( 'woocommerce_before_add_to_cart_form', array( Countdown::instance(), 'add_countdown_to_product_details' ) );
    }
